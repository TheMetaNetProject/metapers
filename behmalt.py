# This file is a slightly modified version of the NLTK scrip, for the Persian Pipeline
...
#beh from nltk.parse.dependencygraph import DependencyGraph
from behdependencygraph import DependencyGraph
